...
class Order extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            [['order_id'], 'required'],
            [['order_id', 'order_mark', 'order_call', 'order_expired',  'order_fromApi', 'order_shipped', 'order_deleted', 'order_uploadedToExternalStoreSystem'], 'integer'],
            [['order_createdAt', 'order_statusUpdatedAt', 'order_markDatetime', 'order_shipmentDate', 'order_certificateDate', 'order_managerId'], 'safe'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'order_createdAt' => 'Дата и время',
            'order_statusUpdatedAt' => 'Последнее изменение статуса',
            ...
            'order_countryIso' => 'Страна',
            'order_uploadedToExternalStoreSystem' => 'Order Uploaded To External Store System',
        ];
    }

    public function getStatus(){
        return $this->hasOne(Status::className(), ['order_status_code' => 'order_status']);
    }
    ...
    public function getSite(){
        return $this->hasOne(Site::className(), ['site_code' => 'order_site']);
    }
    ...
    public function getCountry(){
        return $this->hasOne(VsTaskCountry::className(), ['alpha2' => 'order_countryIso']);
    }
