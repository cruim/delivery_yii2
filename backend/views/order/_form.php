...
use backend\models\VsTaskCountry;
...
<div class="order-form">
    ...
    <?= $form->field($model, 'order_createdAt')->widget(
...
<!--    --><?//= $form->field($model, 'order_countryIso')->dropDownList(
//        ArrayHelper::map(VsTaskCountry::find()->all(), 'order_countryIso', 'alpha2'),
//        ['prompt'=>'Выберите Страну']
//    ) ?>

<!--    --><?//= $form->field($model, 'manager.manager_firstName')->textInput(['maxlength' => true]) ?>
